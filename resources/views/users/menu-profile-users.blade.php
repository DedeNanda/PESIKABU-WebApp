                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8">
                                        <div class="card mx-auto" style="max-width: 25rem;">
                                            ...
                                            @endif
                                            <div class="card-body">
                                                <form action="{{route('proses_ubah_profile2', Auth::id())}}"  method="POST" enctype="multipart/form-data">
                                                    {{ csrf_field() }}
                                                    <div class="mb-3">
                                                        <label for="name" class="form-label mb-0">Nama Pengguna</label>
                                                        <input type="text" class="form-control" name="name" name="name" value="{{ Auth::user()->name }}" autocomplete="name">
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <small class="file-size-info">* Ukuran file foto sekitar 5 MB</small>
                                                    </div>
